                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="form-check form-switch custom-switch-v1">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            ...
                                                                            <?php echo e(isset($admin_payment_setting['is_paiment_pro_enabled']) && $admin_payment_setting['is_paiment_pro_enabled'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                                        <label class="form-check-label"
                                                                            for="customswitchv1-2"></label>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="paiment_pro_merchant_id"
                                                                                ...
                                                                                value="<?php echo e(!isset($admin_payment_setting['paiment_pro_merchant_id']) || is_null($admin_payment_setting['paiment_pro_merchant_id']) ? '' : $admin_payment_setting['paiment_pro_merchant_id']); ?>"
                                                                                placeholder="<?php echo e(__('Merchant Id')); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                            ...
                                                                            <div class="border card p-3">
                                                                                <div class="form-check">
                                                                                    <input type="radio"
                                                                                        ...
                                                                                        class="form-check-input"
                                                                                        <?php echo e(!isset($admin_payment_setting['fedapay_mode']) || $admin_payment_setting['fedapay_mode'] == '' || $admin_payment_setting['fedapay_mode'] == 'sandbox' ? 'checked="checked"' : ''); ?>>
                                                                                    <?php echo e(__('Sandbox')); ?>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="fedapay_public_key"
                                                                                ...
                                                                                value="<?php echo e(!isset($admin_payment_setting['fedapay_public_key']) || is_null($admin_payment_setting['fedapay_public_key']) ? '' : $admin_payment_setting['fedapay_public_key']); ?>"
                                                                                placeholder="<?php echo e(__('Public Key')); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="fedapay_secret_key"
                                                                                ...
                                                                                value="<?php echo e(!isset($admin_payment_setting['fedapay_secret_key']) || is_null($admin_payment_setting['fedapay_secret_key']) ? '' : $admin_payment_setting['fedapay_secret_key']); ?>"
                                                                                placeholder="<?php echo e(__('Secret Key')); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="nepalste_public_key"
                                                                                ...
                                                                                value="<?php echo e(!isset($admin_payment_setting['nepalste_public_key']) || is_null($admin_payment_setting['nepalste_public_key']) ? '' : $admin_payment_setting['nepalste_public_key']); ?>"
                                                                                placeholder="<?php echo e(__('Public Key')); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="nepalste_secret_key"
                                                                                ...
                                                                                value="<?php echo e(!isset($admin_payment_setting['nepalste_secret_key']) || is_null($admin_payment_setting['nepalste_secret_key']) ? '' : $admin_payment_setting['nepalste_secret_key']); ?>"
                                                                                placeholder="<?php echo e(__('Secret Key')); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                            ...
                                                                            <div class="border card p-3">
                                                                                <div class="form-check">
                                                                                    <input type="radio"
                                                                                        ...
                                                                                        class="form-check-input"
                                                                                        <?php echo e(!isset($admin_payment_setting['payhere_mode']) || $admin_payment_setting['payhere_mode'] == '' || $admin_payment_setting['payhere_mode'] == 'sandbox' ? 'checked="checked"' : ''); ?>>
                                                                                    <?php echo e(__('Sandbox')); ?>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="payhere_merchant_id"
                                                                                ...
                                                                                value="<?php echo e(!isset($admin_payment_setting['payhere_merchant_id']) || is_null($admin_payment_setting['payhere_merchant_id']) ? '' : $admin_payment_setting['payhere_merchant_id']); ?>"
                                                                                placeholder="<?php echo e(__('Merchant Id')); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="payhere_merchant_secret_key"
                                                                                ...
                                                                                value="<?php echo e(!isset($admin_payment_setting['payhere_merchant_secret_key']) || is_null($admin_payment_setting['payhere_merchant_secret_key']) ? '' : $admin_payment_setting['payhere_merchant_secret_key']); ?>"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="payhere_app_id"
                                                                                ...
                                                                                value="<?php echo e(!isset($admin_payment_setting['payhere_app_id']) || is_null($admin_payment_setting['payhere_app_id']) ? '' : $admin_payment_setting['payhere_app_id']); ?>"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="payhere_app_secret_key"
                                                                                ...
                                                                                value="<?php echo e(!isset($admin_payment_setting['payhere_app_secret_key']) || is_null($admin_payment_setting['payhere_app_secret_key']) ? '' : $admin_payment_setting['payhere_app_secret_key']); ?>"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="cinetpay_site_id"
                                                                                class="form-label"><?php echo e(__('CinetPay Site ID')); ?></label>
                                                                            <input type="text" name="cinetpay_site_id"
                                                                                id="cinetpay_site_id" class="form-control"
                                                                                value="<?php echo e(!isset($admin_payment_setting['cinetpay_site_id']) || is_null($admin_payment_setting['cinetpay_site_id']) ? '' : $admin_payment_setting['cinetpay_site_id']); ?>"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="cinetpay_api_key"
                                                                                class="form-label"><?php echo e(__('CinetPay API Key')); ?></label>
                                                                            <input type="text" name="cinetpay_api_key"
                                                                                id="cinetpay_api_key" class="form-control"
                                                                                value="<?php echo e(!isset($admin_payment_setting['cinetpay_api_key']) || is_null($admin_payment_setting['cinetpay_api_key']) ? '' : $admin_payment_setting['cinetpay_api_key']); ?>"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="cinetpay_secret_key"
                                                                                class="form-label"><?php echo e(__('CinetPay Secret Key')); ?></label>
                                                                            <input type="text" name="cinetpay_secret_key"
                                                                                id="cinetpay_secret_key" class="form-control"
                                                                                value="<?php echo e(!isset($admin_payment_setting['cinetpay_secret_key']) || is_null($admin_payment_setting['cinetpay_secret_key']) ? '' : $admin_payment_setting['cinetpay_secret_key']); ?>"
                                                                                placeholder="<?php echo e(__('CinetPay Secret Key')); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="form-check form-switch custom-switch-v1">
                                                                            ...
                                                                            <input type="checkbox"
                                                                                class="form-check-input input-primary"
                                                                                name="is_paiment_pro_enabled" id="is_paiment_pro_enabled"
                                                                                <?php echo e(isset($store_payment_setting['is_paiment_pro_enabled']) && $store_payment_setting['is_paiment_pro_enabled'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                                            <label class="form-check-label"
                                                                                for="customswitchv1-2"></label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="paiment_pro_merchant_id"
                                                                                    id="paiment_pro_merchant_id" class="form-control"
                                                                                    value="<?php echo e(!isset($store_payment_setting['paiment_pro_merchant_id']) || is_null($store_payment_setting['paiment_pro_merchant_id']) ? '' : $store_payment_setting['paiment_pro_merchant_id']); ?>"
                                                                                    placeholder="<?php echo e(__('Merchant Id')); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="form-check form-switch custom-switch-v1">
                                                                            ...
                                                                            <input type="checkbox"
                                                                                class="form-check-input input-primary"
                                                                                name="is_fedapay_enabled" id="is_fedapay_enabled"
                                                                                <?php echo e(isset($store_payment_setting['is_fedapay_enabled']) && $store_payment_setting['is_fedapay_enabled'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                                            <label class="form-check-label"
                                                                                for="customswitchv1-2"></label>
                                                                        </div>
                                                                    </div>
                                                                                ...
                                                                                <div class="border card p-3">
                                                                                    <div class="form-check">
                                                                                        <input type="radio"
                                                                                            name="fedapay_mode" value="sandbox"
                                                                                            class="form-check-input"
                                                                                            <?php echo e(!isset($store_payment_setting['fedapay_mode']) || $store_payment_setting['fedapay_mode'] == '' || $store_payment_setting['fedapay_mode'] == 'sandbox' ? 'checked="checked"' : ''); ?>>
                                                                                        <?php echo e(__('Sandbox')); ?>
                                                                                ...
                                                                                <div class="border card p-3">
                                                                                    <div class="form-check">
                                                                                        <input type="radio"
                                                                                            name="fedapay_mode" value="live"
                                                                                            class="form-check-input"
                                                                                            <?php echo e(isset($store_payment_setting['fedapay_mode']) && $store_payment_setting['fedapay_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                                        <?php echo e(__('Live')); ?>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="fedapay_public_key"
                                                                                    id="fedapay_public_key" class="form-control"
                                                                                    value="<?php echo e(!isset($store_payment_setting['fedapay_public_key']) || is_null($store_payment_setting['fedapay_public_key']) ? '' : $store_payment_setting['fedapay_public_key']); ?>"
                                                                                    placeholder="<?php echo e(__('Public Key')); ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="fedapay_secret_key"
                                                                                    id="fedapay_secret_key" class="form-control"
                                                                                    value="<?php echo e(!isset($store_payment_setting['fedapay_secret_key']) || is_null($store_payment_setting['fedapay_secret_key']) ? '' : $store_payment_setting['fedapay_secret_key']); ?>"
                                                                                    placeholder="<?php echo e(__('Secret Key')); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="form-check form-switch custom-switch-v1">
                                                                            ...
                                                                            <input type="checkbox"
                                                                                class="form-check-input input-primary"
                                                                                name="is_nepalste_enabled" id="is_nepalste_enabled"
                                                                                <?php echo e(isset($store_payment_setting['is_nepalste_enabled']) && $store_payment_setting['is_nepalste_enabled'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                                            <label class="form-check-label"
                                                                                for="customswitchv1-2"></label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="nepalste_public_key"
                                                                                    id="nepalste_public_key" class="form-control"
                                                                                    value="<?php echo e(!isset($store_payment_setting['nepalste_public_key']) || is_null($store_payment_setting['nepalste_public_key']) ? '' : $store_payment_setting['nepalste_public_key']); ?>"
                                                                                    placeholder="<?php echo e(__('Public Key')); ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="nepalste_secret_key"
                                                                                    id="nepalste_secret_key" class="form-control"
                                                                                    value="<?php echo e(!isset($store_payment_setting['nepalste_secret_key']) || is_null($store_payment_setting['nepalste_secret_key']) ? '' : $store_payment_setting['nepalste_secret_key']); ?>"
                                                                                    placeholder="<?php echo e(__('Secret Key')); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="form-check form-switch custom-switch-v1">
                                                                            ...
                                                                            <input type="checkbox"
                                                                                class="form-check-input input-primary"
                                                                                name="is_payhere_enabled" id="is_payhere_enabled"
                                                                                <?php echo e(isset($store_payment_setting['is_payhere_enabled']) && $store_payment_setting['is_payhere_enabled'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                                            <label class="form-check-label"
                                                                                for="customswitchv1-2"></label>
                                                                        </div>
                                                                    </div>
                                                                                ...
                                                                                <div class="border card p-3">
                                                                                    <div class="form-check">
                                                                                        <input type="radio"
                                                                                            name="payhere_mode" value="sandbox"
                                                                                            class="form-check-input"
                                                                                            <?php echo e(!isset($store_payment_setting['payhere_mode']) || $store_payment_setting['payhere_mode'] == '' || $store_payment_setting['payhere_mode'] == 'sandbox' ? 'checked="checked"' : ''); ?>>
                                                                                        <?php echo e(__('Sandbox')); ?>
                                                                                ...
                                                                                <div class="border card p-3">
                                                                                    <div class="form-check">
                                                                                        <input type="radio"
                                                                                            name="payhere_mode" value="live"
                                                                                            class="form-check-input"
                                                                                            <?php echo e(isset($store_payment_setting['payhere_mode']) && $store_payment_setting['payhere_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                                        <?php echo e(__('Live')); ?>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="payhere_merchant_id"
                                                                                    id="payhere_merchant_id" class="form-control"
                                                                                    value="<?php echo e(!isset($store_payment_setting['payhere_merchant_id']) || is_null($store_payment_setting['payhere_merchant_id']) ? '' : $store_payment_setting['payhere_merchant_id']); ?>"
                                                                                    placeholder="<?php echo e(__('Merchant Id')); ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="payhere_merchant_secret_key"
                                                                                    id="payhere_merchant_secret_key" class="form-control"
                                                                                    value="<?php echo e(!isset($store_payment_setting['payhere_merchant_secret_key']) || is_null($store_payment_setting['payhere_merchant_secret_key']) ? '' : $store_payment_setting['payhere_merchant_secret_key']); ?>"
                                                                                    placeholder="<?php echo e(__('Merchant Secret')); ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="payhere_app_id"
                                                                                    id="payhere_app_id" class="form-control"
                                                                                    value="<?php echo e(!isset($store_payment_setting['payhere_app_id']) || is_null($store_payment_setting['payhere_app_id']) ? '' : $store_payment_setting['payhere_app_id']); ?>"
                                                                                    placeholder="<?php echo e(__('App ID')); ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="payhere_app_secret_key"
                                                                                    id="payhere_app_secret_key" class="form-control"
                                                                                    value="<?php echo e(!isset($store_payment_setting['payhere_app_secret_key']) || is_null($store_payment_setting['payhere_app_secret_key']) ? '' : $store_payment_setting['payhere_app_secret_key']); ?>"
                                                                                    placeholder="<?php echo e(__('App Secret')); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="form-check form-switch custom-switch-v1">
                                                                            ...
                                                                            <input type="checkbox"
                                                                                class="form-check-input input-primary"
                                                                                name="is_cinetpay_enabled" id="is_cinetpay_enabled"
                                                                                <?php echo e(isset($store_payment_setting['is_cinetpay_enabled']) && $store_payment_setting['is_cinetpay_enabled'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                                            <label class="form-check-label"
                                                                                for="customswitchv1-2"></label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="cinetpay_site_id"
                                                                                    id="cinetpay_site_id" class="form-control"
                                                                                    value="<?php echo e(!isset($store_payment_setting['cinetpay_site_id']) || is_null($store_payment_setting['cinetpay_site_id']) ? '' : $store_payment_setting['cinetpay_site_id']); ?>"
                                                                                    placeholder="<?php echo e(__('CinetPay Site ID')); ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="cinetpay_api_key"
                                                                                    id="cinetpay_api_key" class="form-control"
                                                                                    value="<?php echo e(!isset($store_payment_setting['cinetpay_api_key']) || is_null($store_payment_setting['cinetpay_api_key']) ? '' : $store_payment_setting['cinetpay_api_key']); ?>"
                                                                                    placeholder="<?php echo e(__('CinetPay API Key')); ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="cinetpay_secret_key"
                                                                                    id="cinetpay_secret_key" class="form-control"
                                                                                    value="<?php echo e(!isset($store_payment_setting['cinetpay_secret_key']) || is_null($store_payment_setting['cinetpay_secret_key']) ? '' : $store_payment_setting['cinetpay_secret_key']); ?>"
                                                                                    placeholder="<?php echo e(__('CinetPay Secret Key')); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hamza\OneDrive\Bureau\Whatsapp store Codebase\main-file\resources\views/settings/index.blade.php ENDPATH**/ ?>